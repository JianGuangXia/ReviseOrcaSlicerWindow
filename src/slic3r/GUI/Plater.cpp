    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(42 * wxGetApp().em_unit(), -1)), p(new priv(parent))
{
    ...
    // add printer
    {
        ...
        #ifdef _HIDE_PRITER_SETTING
        p->m_printer_setting->Hide();
        #endif // _HIDE_PRITER_SETTING
        ...
        // Bed type selection
#ifdef _DELETE_BED_TYPE_COMBOX_
#else
...
#endif // _DELETE_BED_TYPE_COMBOX_
