...
wxWindow* PreferencesDialog::create_general_page()
{
    ...
    auto title_associate_file = create_item_title(_L("Associate files to FormLetter"), page, _L("Associate files to FormLetter"));

    // associate file
    auto item_associate_3mf  = create_item_checkbox(_L("Associate .3mf files to FormLetter"), page,
                                                   _L("If enabled, sets FormLetter as default application to open .3mf files"), 50,
                                                   "associate_3mf");
    auto item_associate_stl  = create_item_checkbox(_L("Associate .stl files to FormLetter"), page,
                                                   _L("If enabled, sets FormLetter as default application to open .stl files"), 50,
                                                   "associate_stl");
    auto item_associate_step = create_item_checkbox(_L("Associate .step/.stp files to FormLetter"), page,
                                                    _L("If enabled, sets FormLetter as default application to open .step files"), 50,
                                                    "associate_step");
    ...
    auto title_develop_mode = create_item_title(_L("Advanced mode"), page, _L("Develop mode"));
    auto item_develop_mode  = create_item_checkbox(_L("Advanced mode"), page, _L("Develop mode"), 50, "developer_mode");
    #if 0 
